...
public class LestariDialogue : MonoBehaviour
{
    ...
    public void StartDialogue()
    {
        DialogueData[] data =
        {
            new DialogueData(true, "Selamat siang, Bu. Saya Dani, penyidik yang menangani kasus ini."),
            ...
            new DialogueData(false, "Kagak dikunci rapet. Saya ketok-ketok kaga ada jawaban. Pas saya buka dikit... Ya Allah, saya langsung teriak."),
            ...
            new DialogueData(false, "Kagak ada."),
            ...
            new DialogueData(false, "Oh gitu. Yaudah Nak, semoga cepet ketemu jawabannya."),
