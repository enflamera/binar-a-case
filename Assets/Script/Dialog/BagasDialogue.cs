...
public class BagasDialogue : MonoBehaviour
{
    ...
    [Header("Expression")]
    public Sprite marahExpression;
    public Sprite defaultExpression;
    public Sprite mikirExpression;

    void Start()
    {
        DialogueData[] data =
        {
            new DialogueData(true, "Permisi, Bagas? Saya Dani, penyidik. Saya ingin bertanya beberapa hal soal Binar jika Anda tidak keberatan.", expression: marahExpression),
            ...
            new DialogueData(false, "Buset, Bang, jangan main angkut aje. Iya dah iya, gue jawab. Polisi sekarang mulutnye pedes bener.", expression: defaultExpression),
            ...
            new DialogueData(true, "Ada obrolan penting sepanjang jalan?", expression: mikirExpression),
            ...
            new DialogueData(true, "Nah! Iya, iya bener.", expression: defaultExpression),
