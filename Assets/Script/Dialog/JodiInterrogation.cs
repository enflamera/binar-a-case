...
public class JodiInterrogation : MonoBehaviour
{
    ...
    void Start()
    {
        DialogueData[] data =
        {
            new DialogueData(true, "Brigadir Jodi, saya akan bertanya sekali lagi.", expression: defaultExpression),
            ...
            new DialogueData(false, "...", expression: takutExpression),
            ...
            new DialogueData(false, "...", expression: kagetExpression),
            ...
            new DialogueData(false, "Saya...", expression: takutExpression),
